...
MODEL_PATH = "/mount/src/int421-applied-ml/assignment-4/models/house-price-regression.pkl"
TRAIN_PATH = "/mount/src/int421-applied-ml/assignment-4/datasets/train.csv"
